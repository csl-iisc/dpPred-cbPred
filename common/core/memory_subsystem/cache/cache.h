...
class Cache : public CacheBase
{
   ...
   public:
      ...
      void insertSingleLine(IntPtr addr, Byte* fill_buff,
            ...
            CacheBlockInfo* evict_block_info, Byte* evict_buff, SubsecondTime now, CacheCntlr *cntlr = NULL, bool LLC = false, bool L2TLB = false);
      CacheBlockInfo* peekSingleLine(IntPtr addr);
       void increaseCForEntireSet (IntPtr addr);
       void modifyCounterForEntireSet (IntPtr addr, std::map<IntPtr, std::pair<uint64_t, IntPtr>> &phy_table);
      void setPrDeadBit (IntPtr address);
      ...
      UInt32 blkSize() { return m_blocksize; }
