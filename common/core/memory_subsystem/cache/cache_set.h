...
class CacheSet
{
   ...
   public:
      ...
      void insert(CacheBlockInfo* cache_block_info, Byte* fill_buff, bool* eviction, CacheBlockInfo* evict_block_info, Byte* evict_buff, CacheCntlr *cntlr = NULL, bool LLC = false, bool L2TLB = false);
      ...
      virtual UInt32 getReplacementIndex(CacheCntlr *cntlr, bool LLC = false, bool L2TLB = false) = 0;
     // virtual UInt32 getMyReplacementIndex(CacheCntlr *cntlr) = 0;
