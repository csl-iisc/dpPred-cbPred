...
namespace ParametricDramDirectoryMSI
{
   ...
   class CacheCntlr : ::CacheCntlr
   {
      private:
         ...
         SharedCacheBlockInfo* insertCacheBlock(IntPtr address, CacheState::cstate_t cstate, Byte* data_buf, core_id_t requester, ShmemPerfModel::Thread_t thread_num, bool isLLC = false);
         ...
         HitWhere::where_t processShmemReqFromPrevCache(CacheCntlr* requester, Core::mem_op_t mem_op_type, IntPtr address, bool modeled, bool count, Prefetch::prefetch_type_t isPrefetch, SubsecondTime t_issue, bool have_write_lock, bool onCacheMiss = false);
      ...
      public:
         ...
         bool accessCacheLine(IntPtr addr);
